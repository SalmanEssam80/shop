...
<body class="hold-transition dark-mode sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed">
    <div class="wrapper">
        <div class="preloader flex-column justify-content-center align-items-center">
            <img class="animation__wobble" src="{{ asset('adminArea/dist/img/AdminLTELogo.png') }}" alt="AdminLTELogo"
                height="60" width="60">
        </div>
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            <a href="index3.html" class="brand-link">
                <img src="{{ asset('adminArea/dist/img/AdminLTELogo.png') }}" alt="AdminLTE Logo"
            ...
            <div class="sidebar">
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="image">
                        <img src="{{ asset('adminArea/dist/img/user2-160x160.jpg') }}" class="img-circle elevation-2"
                            alt="User Image">
                    </div>
                    <div class="info">
        ...
        <div class="content-wrapper">
            ...
            <footer class="main-footer">
                <strong>Copyright &copy; 2023 Designed By <a href="">AdminLTE.io</a> and Developed By <a
                        href="https://github.com/SalmanEssam80">Salman Essam</a></strong>
                All rights reserved.
            </footer>
        </div>
