...
@section('content')
    <section class="about section">
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <img class="img-responsive" src="image/about/about.jpg">
                </div>
                <div class="col-md-6">
            ...
            <div class="row mt-40">
                <div class="col-md-3 text-center">
                    <img src="image/about/awards-logo.png">
                </div>
                <div class="col-md-3 text-center">
                    <img src="image/about/awards-logo.png">
                </div>
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="team-member text-center">
                        <img class="img-circle" src="image/team/team-1.jpg">
                ...
                <div class="col-md-4">
                    <div class="team-member text-center">
                        <img class="img-circle" src="image/team/team-2.jpg">
                ...
                <div class="col-md-4">
                    <div class="team-member text-center">
                        <img class="img-circle" src="image/team/team-3.jpg">
                        <h4>John Fexit</h4>
                        <p>Shop Manager</p>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <a class="play-icon" href="https://www.youtube.com/watch?v=rYEDA3JcQqw" data-toggle="lightbox">
